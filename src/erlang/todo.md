...
- [x] Post endpoint for java to send starting of auction
- [x] Post endpoint for java to send user connecting to auction
- [ ] reject websocket connection of users not connected to auction
- [ ] add starting time when adding auction with post
